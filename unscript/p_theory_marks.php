...
$query_marks="SELECT * FROM `marks`,`subject` WHERE ((marks.student_id = '$student_id' and m_sem = '$semister') and subject.type = 1) and marks.sub_id = subject.sub_id";
    ...
    <div class="row">
        ...
        <div class="jumbotron-3">
            <div class="jumbotron jumbotron-fluid">
                <div class="container-fluid">
                    <h1 class="display-3">Theory Marks</h1>
