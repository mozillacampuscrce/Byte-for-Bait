...
$query_marks="SELECT * FROM `marks`,`subject` WHERE ((marks.student_id = '$student_id' and m_sem = '$semister') and subject.type = 0) and marks.sub_id = subject.sub_id";
    ...
    <div class="row">
        ...
        <div class="jumbotron-3">
            <div class="jumbotron jumbotron-fluid">
                <div class="container-fluid">
                    <h1 class="display-3">Practical Marks</h1>
                                    ...
                                    <table class="table" data-filtering="true" data-sorting="true" data-paging="true" data-filtering-delay="0" id="ptable">
                                        ...
                                        while($data_marks = $res_marks -> fetch_assoc()){
                                            ...
                                            <tr class="tablerow<?php echo $data['id'];?>">
                                                ...
                                                <td><?php echo $data_marks['mrk']*100/50;?>%</td>
