...
$query_attendance="SELECT * FROM `attendance`,`subject` WHERE ((attendance.student_id = '$student_id' and a_sem = '$semister') and subject.type = 1) and attendance.sub_id = subject.sub_id";
